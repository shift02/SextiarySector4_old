    ...
    static class RenderPlayerMethodVisitor extends AnalyzerAdapter {
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
            ...
            if (opcode == INVOKEVIRTUAL
                ...
                //Methodを呼ぶ
                mv.visitMethodInsn(INVOKESTATIC, "shift/sextiarysector4/core/asm/vanilla/InventoryPlayerMethod", "armorItemInSlot",
                        "(ILnet/minecraft/client/entity/AbstractClientPlayer;)Lnet/minecraft/item/ItemStack;", false);
