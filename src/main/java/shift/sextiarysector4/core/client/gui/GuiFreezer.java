package shift.sextiarysector4.core.client.gui;
...
public class GuiFreezer extends GuiContainer implements IRecipeShownListener {
    ...
    private static final ResourceLocation FURNACE_GUI_TEXTURES = new ResourceLocation(SextiarySector4.MOD_ID, "textures/gui/container/freezer.png");
    ...
    public void initGui() {
        ...
        this.addButton(new GuiButtonImage(10, this.guiLeft + 20, this.height / 2 - 49, 20, 18, 0, 0, 19, RECIPE_BUTTON_TEXTURE) {
            ...
            public void onClick(double mouseX, double mouseY) {
                ...
                GuiFreezer.this.recipeBook.func_201518_a(GuiFreezer.this.canRenderRecipeBook);
                GuiFreezer.this.recipeBook.toggleVisibility();
                GuiFreezer.this.guiLeft = GuiFreezer.this.recipeBook.updateScreenPosition(GuiFreezer.this.canRenderRecipeBook, GuiFreezer.this.width, GuiFreezer.this.xSize);
                this.setPosition(GuiFreezer.this.guiLeft + 20, GuiFreezer.this.height / 2 - 49);
            }
