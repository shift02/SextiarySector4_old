package shift.sextiarysector4.core.common.crafting;
...
public class FreezerRecipe implements IRecipe, ISimpleRecipe {
    ...
    public IRecipeSerializer<?> getSerializer() {
        return SSCoreRecipeSerializers.FREEZING;
    }
    ...
    public RecipeType<? extends IRecipe> getType() {
        return SSCoreRecipeTypes.FREEZING;
    }

    public static class Serializer implements IRecipeSerializer<FreezerRecipe> {

        private static ResourceLocation NAME = new ResourceLocation(SextiarySector4.MOD_ID, "freezing");

        public FreezerRecipe read(ResourceLocation recipeId, JsonObject json) {
        ...
        public FreezerRecipe read(ResourceLocation recipeId, PacketBuffer buffer) {
            String s = buffer.readString(32767);
            Ingredient ingredient = Ingredient.fromBuffer(buffer);
            ItemStack itemstack = buffer.readItemStack();
            float f = buffer.readFloat();
            int i = buffer.readVarInt();
            return new FreezerRecipe(recipeId, s, ingredient, itemstack, f, i);
        }

        @Override
        public void write(PacketBuffer buffer, FreezerRecipe recipe) {
