...
public class ContainerPlayerNext extends Container {
    ...
    public ContainerPlayerNext(InventoryPlayer par1InventoryPlayer, EntityPlayer p_i1819_3_) {
        ...
        for (i = 0; i < 4; ++i) {
            ...
            this.addSlotToContainer(new Slot(par1InventoryPlayer, par1InventoryPlayer.getSizeInventory() - 1 - i - 1, 8, 8 + i * 18) {
                ...
                public boolean isItemValid(ItemStack p_75214_1_) {
                    ...
                    return p_75214_1_.getItem().isValidArmor(p_75214_1_, entityequipmentslot, player);
                }
        ...
        this.addSlotToContainer(new SlotEquipment(EquipmentType.DecorationHelmet, this.equipment, 0, 80 + 0 * 18, 8 + 0 * 18) {
            ...
            public boolean isItemValid(ItemStack p_75214_1_) {
                if (p_75214_1_ == null) return false;
                return p_75214_1_.getItem().isValidArmor(p_75214_1_, VALID_EQUIPMENT_SLOTS[0], player);
            }
        ...
        this.addSlotToContainer(new SlotEquipment(EquipmentType.DecorationPlate, this.equipment, 1, 80 + 0 * 18, 8 + 1 * 18) {
            ...
            public boolean isItemValid(ItemStack p_75214_1_) {
                if (p_75214_1_ == null) return false;
                return p_75214_1_.getItem().isValidArmor(p_75214_1_, VALID_EQUIPMENT_SLOTS[1], player);
            }
        ...
        this.addSlotToContainer(new SlotEquipment(EquipmentType.DecorationLegs, this.equipment, 2, 80 + 0 * 18, 8 + 2 * 18) {
            ...
            public boolean isItemValid(ItemStack p_75214_1_) {
                if (p_75214_1_ == null) return false;
                return p_75214_1_.getItem().isValidArmor(p_75214_1_, VALID_EQUIPMENT_SLOTS[2], player);
            }
        ...
        this.addSlotToContainer(new SlotEquipment(EquipmentType.DecorationBoots, this.equipment, 3, 80 + 0 * 18, 8 + 3 * 18) {
            ...
            public boolean isItemValid(ItemStack p_75214_1_) {
                if (p_75214_1_ == null) return false;
                return p_75214_1_.getItem().isValidArmor(p_75214_1_, VALID_EQUIPMENT_SLOTS[3], player);
            }
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (!((0 <= p_82846_2_ && p_82846_2_ <= 3) || (40 <= p_82846_2_ && p_82846_2_ <= 60))) {
                ...
                if (itemstack.getItem() instanceof ItemArmor && !this.inventorySlots.get(0 + ((ItemArmor) itemstack.getItem()).armorType.getIndex()).getHasStack()) {
                    int j = 0 + ((ItemArmor) itemstack.getItem()).armorType.getIndex();
                    
                    if (!this.mergeItemStack(itemstack1, j, j + 1, false)) {
                        return null;
                    }
                } else if (itemstack.getItem() instanceof ItemArmor && !this.inventorySlots.get(40 + ((ItemArmor) itemstack.getItem()).armorType.getIndex()).getHasStack()) {
                    int j = 40 + ((ItemArmor) itemstack.getItem()).armorType.getIndex();
