package shift.sextiarysector4.inventory;
...
import shift.sextiarysector4.lib.inventory.SlotFuel;
import shift.sextiarysector4.lib.recipe.FreezerFuel;

public class ContainerFreezer extends ContainerRecipeBook {
    ...
    public ContainerFreezer(InventoryPlayer playerInventory, IInventory furnaceInventory) {
        ...
        this.addSlot(new Slot(furnaceInventory, 0, 56, 53));
        this.addSlot(new SlotFuel(furnaceInventory, 1, 56, 17, FreezerFuel::isItemFuel));
    ...
    private boolean canSmelt(ItemStack p_206253_1_) {
        for (IRecipe irecipe : this.world.getRecipeManager().getRecipes(SSCoreRecipeTypes.FREEZING)) {
